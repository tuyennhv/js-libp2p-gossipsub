...
import { Message, PublishResult, PubSub, PubSubEvents, PubSubInit, StrictNoSign, StrictSign } from '@libp2p/interface-pubsub';
...
export declare class GossipSub extends EventEmitter<GossipsubEvents> implements Initializable, PubSub<GossipsubEvents> {
     ...
     */
    publish(topic: TopicStr, data: Uint8Array, batch?: boolean): Promise<PublishResult>;
    /**
